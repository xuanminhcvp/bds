...
Revision ID: 376b42a5818f
Revises: d8e017908706
Create Date: 2025-03-05 19:43:21.750341
...
revision: str = '376b42a5818f'
down_revision: Union[str, None] = 'd8e017908706'
...
def upgrade() -> None:
    ...
    sa.Column('commission_amout', sa.DECIMAL(precision=10, scale=2), nullable=True),
