...
const exec$1 = /* @__PURE__ */ __name$5((command, arguments_, { shell, env } = {}) => node_child_process.execFileSync(command, arguments_, {
  encoding: "utf8",
...
const tput = /* @__PURE__ */ __name$5(() => {
  try {
    const columns = exec$1("tput", ["cols"], { env: { TERM: "dumb", ...process__default.env } });
    const rows = exec$1("tput", ["lines"], { env: { TERM: "dumb", ...process__default.env } });
    if (columns && rows) {
