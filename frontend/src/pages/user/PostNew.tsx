...
const PostNewPage: React.FC = () => {
  const { addProperty, isLoadingProperty, errorProperty } =
    useRealEstateStore();
  ...
  return (
    <Box p={6} maxW="2xl" mx="auto" overflowY="auto" maxHeight="80vh" 
      sx={{
        '&::-webkit-scrollbar': {
          display: 'none', 
        },
      ...
      <VStack gap={6} align="stretch">
        ...
        <form onSubmit={handleSubmit}>
          <VStack gap={4} >
            ...
            <FormControl
              isRequired
              isInvalid={formData.price > 0 && formData.price <= 0}
            >
              ...
              />
              <FormErrorMessage>Giá phải lớn hơn 0.</FormErrorMessage>
            </FormControl>

            {/* Diện tích */}
            <FormControl
              isRequired
              isInvalid={formData.area > 0 && formData.area <= 0}
            >
            ...
            <FormControl
              isRequired
              isInvalid={formData.bedrooms > 0 && formData.bedrooms <= 0}
            >
              ...
              />
              <FormErrorMessage>Số phòng ngủ phải lớn hơn 0.</FormErrorMessage>
            </FormControl>

            {/* Số phòng tắm */}
            <FormControl
              isRequired
              isInvalid={formData.bathrooms > 0 && formData.bathrooms <= 0}
            >
              ...
              />
              <FormErrorMessage>Số phòng tắm phải lớn hơn 0.</FormErrorMessage>
            </FormControl>
