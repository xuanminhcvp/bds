        ...
        <Flex justify="space-between" align="center">
          ...
          <Flex align="center">
            <Link _hover={{ textDecoration: 'none' }} as={RouterLink} to="/">
              <Flex align="center">
                <Box ml={2}>
                  <Text fontSize="lg" fontWeight="bold" color="red.500" lineHeight="1.2">
                    Bất Động Sản
                  </Text>
          ...
          <HStack gap={4}>
            ...
            <Link _hover={{ textDecoration: 'none' }} as={RouterLink} to="/postnew">
              <Button colorScheme="teal" variant="outline">
                Đăng tin
              </Button>
            </Link>
            ...
            <Link _hover={{ textDecoration: 'none' }} as={RouterLink} to="/signup">
